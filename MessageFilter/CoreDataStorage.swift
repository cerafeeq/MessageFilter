...
open class CoreDataStorage {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "SMSFilter", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let directory = FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: "group.com.rainierlabs.SMSFilter")!
        let url = directory.appendingPathComponent("SMSFilter.sqlite")
        do {
